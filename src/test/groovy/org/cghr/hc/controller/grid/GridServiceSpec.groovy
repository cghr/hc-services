...
class GridServiceSpec extends Specification {
    ...
    def "should respond with status ok for  enum services"() {
        ...
        mockMvc.perform(get('/GridService/enum/area/13/house/3813001/household/381300101/death'))
                .andExpect(status().isOk())

        mockMvc.perform(get('/GridService/enum/area/13/house/3813001/household/381300101/hosp'))
                .andExpect(status().isOk())

    }
    def "should respond with status ok for  hc services"() {

        expect:
        mockMvc.perform(get('/GridService/hc/area'))
                .andExpect(status().isOk())

        mockMvc.perform(get('/GridService/hc/area/13/house'))
                .andExpect(status().isOk())

        mockMvc.perform(get('/GridService/hc/area/13/house/3813001/household'))
                .andExpect(status().isOk())

        mockMvc.perform(get('/GridService/hc/area/13/house/3813001/household/381300101/visit'))
                .andExpect(status().isOk())

        mockMvc.perform(get('/GridService/hc/area/13/house/3813001/household/381300101/member'))
                .andExpect(status().isOk())

        mockMvc.perform(get('/GridService/hc/area/13/house/3813001/household/381300101/ffq'))
                .andExpect(status().isOk())
